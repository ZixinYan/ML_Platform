package com.ml.gamegetflag.controller;
...
import com.ml.gamegetflag.service.impl.GameServiceImpl;
import com.ml.gamegetflag.service.impl.KafkaProducerServiceImpl;
...
public class ChatController {
    ...
    @PostMapping("/success")
    public R success(@RequestParam String requestId, @RequestParam String flag,@RequestParam Long memberId) {
        flag = "flag{" + flag + "}";
        if(gameService.success(requestId,flag,memberId)) {
            return R.ok();
        }else{
            return R.error();
        }
